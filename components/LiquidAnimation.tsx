...
function LiquidBlob() {
  ...
  const vertexShader = `
    ...
    void main() {
      ...
      vec3 pos = position;
      float noise = snoise(pos * 1.5 + u_time * 0.5) * 0.3;
      noise += snoise(pos * 3.0 + u_time * 0.3) * 0.15;
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      float mixValue1 = sin(vUv.x * 3.14159 + u_time) * 0.5 + 0.5;
      float mixValue2 = cos(vUv.y * 3.14159 + u_time * 0.7) * 0.5 + 0.5;
